...
//        pakai ini
            ...
            $reload = "listpendingdmcaseam.php?pagination=true&keyword=$keyword&username=$username&name=$name&data=$datatest";
			$sql="select * from tbl_acctmaintenancetemp where flagWF='amtodm' and ($strTable like '%$keyword%')";
	...
	//jika tidak ada pencarian pakai ini
            $reload = "listpendingdmcaseam.php?pagination=true&username=$username&name=$name&data=$datatest";
            //$sql =  "select * from tbl_acctmaintenancetemp";
			$sql =  "select * from tbl_acctmaintenancetemp where flagWF='amtodm'";
            $result = mysql_query($sql);
			$rwdt = mysql_fetch_array($result);
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    if($_REQUEST['keyword']<>""){
                    ?>
                        <a class="btn btn-default btn-outline" href="listpendingdmcaseam.php?username=<?php echo $username; ?>&name=<?php echo $name?>&data=<?php echo $datatest;?>"> Reset Pencarian</a>
                    <?php
                    }
                    ?>
                </div>
				...
				<hr/>
                    <form method="get" action="listpendingdmcaseam.php?username=<?php echo $username; ?>&name=<?php echo $name?>&data=<?php echo $datatest;?>">
							...
							<tr>
								...
								<td>
									<span class="input-group-btn">
										<button class="btn btn-primary" type="submit2">Cari
										</button>
									</span>
								</td>
							</tr>	
