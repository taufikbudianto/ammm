...
$reload = "listpendingbalikan.php?pagination=true&username=$username&name=$name&data=$datatest&route=$route&balikan=$balikan";
$sql = "select * from tbl_acctmaintenancetemp a join app_fd_accountmaint b on a.ticketNo=b.c_txtNoTicket where a.flagWF='$route' and b.c_flagWFcontrol='$balikan' and (a.$strTable like '%$keyword%')";
...
<div class="container">
    <div class="row">
        <div class="col-lg-7">
            ...
            if ($_REQUEST['keyword'] <> "") {
                ...
                <a class="btn btn-default btn-outline"
                   href="listpendingbalikan.php?username=<?php echo $username; ?>&name=<?php echo $name ?>&data=<?php echo $datatest; ?>&route=<?php echo $route; ?>&balikan=<?php echo $balikan; ?>">
                    Reset Pencarian</a>
                <?php
            }
            ?>
        ...
        <div class="col-lg-5">
            <hr/>
            <form method="get"
                  action="listpendingbalikan.php?username=<?php echo $username; ?>&name=<?php echo $name ?>&data=<?php echo $datatest; ?>&route=<?php echo $route; ?>&balikan=<?php echo $balikan; ?>">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" name="keyword" class="form-control"
                                ...
                                <input type="hidden" name="routedata" value="am">
                                <input type="hidden" name="route" value="am">
                                <input type="hidden" name="balikan" value="am">
                            </td>
                            <td>
    ...
    <!--<form method="post" action="http://172.29.109.116:8080/complete">-->
