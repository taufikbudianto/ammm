...
//        pakai ini
            ...
            $reload = "listpendingdmcasermu.php?pagination=true&keyword=$keyword";
			$sql="select * from tbl_acctmaintenancetemp where flagWF='rmu' and ($strTable like '%$keyword%')";
	...
	//jika tidak ada pencarian pakai ini
            $reload = "listpendingdmcasermu.php?pagination=true";
            //$sql =  "select * from tbl_acctmaintenancetemp";
			$sql =  "select * from tbl_acctmaintenancetemp where flagWF='rmu'";
            $result = mysql_query($sql);
			$rwdt = mysql_fetch_array($result);
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    if($_REQUEST['keyword']<>""){
                    ?>
						<a class="btn btn-default btn-outline" href="listpendingrmucasedm.php?username=<?php echo $username; ?>&name=<?php echo $name?>&data=<?php echo $datatest;?>"> Reset Pencarian</a>
                    <?php
                    }
                    ?>
                </div>
				...
				<hr/>
                     <form method="get" action="listpendingrmucasedm.php?username=<?php echo $username; ?>&name=<?php echo $name?>&data=<?php echo $datatest;?>">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
					...
					<tr>
						...
						<input type="hidden" name="routedata" value="toDM">
